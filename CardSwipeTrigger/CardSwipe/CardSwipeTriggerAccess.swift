...
class CardSwipeTriggerAccess:NSObject {
    ...
    static func firstTimeRearrangeCardView() {
    ...
    static func cardSwipe(arrView:[[UIView:Any]]? = nil, superview:UIView, delegate:CardSwipeTriggerDelegate?, swipeLevel:SwipeLevel = .medium) {
                ...
                if var arrView = arrView {
                    ...
                    for i in 0..<arrView.count {
                        ...
                        if (arrView.count - 1) == i {
                            ...
                            CardSwipeTriggerAccess.firstTimeRearrangeCardView()
                        }else {
